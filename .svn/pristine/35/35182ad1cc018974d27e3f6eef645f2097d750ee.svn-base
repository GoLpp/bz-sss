 ...
 */
@Entity
@Table(name="bz_health_vq")    //健康度
public class Vq {
	@SuppressWarnings("unused")
	private final static Logger LOG = LogManager.getLogger(Vq.class);
	...
	public Vq(String id, Date collectedTime, String collectedValue, Watch watch, Staff staff, Task task,
			Gateway gateway) {
		super();
		this.id = id;
		this.collectedTime = collectedTime;
	...
	public String toString() {
		return "Vq [id=" + id + ", collectedTime=" + collectedTime + ", collectedValue=" + collectedValue + ", watch="
				+ watch + ", staff=" + staff + ", task=" + task + ", gateway=" + gateway + "]";
	}
